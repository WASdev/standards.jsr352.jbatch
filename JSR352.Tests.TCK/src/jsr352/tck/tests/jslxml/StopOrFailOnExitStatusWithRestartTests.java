...
public class StopOrFailOnExitStatusWithRestartTests {
    ...
    public void testStopOnEndOn() throws Exception {
		...
		try {
	        ...
	        assertWithMessage("Testing execution #1", BatchStatus.STOPPED, execution1.getExitStatus());
	...
	
	        {
	            ...
	            Reporter.log("Invoke restartJobAndWaitForResult with executionId: " + jobInstanceId + "<p>");
	...
	
	        {
	            ...
	            assertWithMessage("Testing execution #3", BatchStatus.COMPLETED, exec.getExitStatus());
