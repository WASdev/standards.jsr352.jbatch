...
public class JobOperatorTests {
	...
	@Test
	@org.junit.Test
    public void testJobOperatorGetRunningJobInstances() throws Exception {
        ...
        try {
			...
			exec = jobOp.startJobWithoutWaitingForResult("job_batchlet_step_listener", jobParametersOverride);
	         ...
	         List<JobInstance> jobInstances = jobOp.getRunningInstances("job_batchlet_step_listener");
	         assertWithMessage("Found job instances in the RUNNING state", jobInstances.size() > 0);
    ...
    public void testJobOperatorGetRunningJobInstancesExeception() throws Exception {
        ...
        try {
			...
			try {
				...
				jobOp.getRunningInstances("JOBNAMEDOESNOTEXIST");
			}
			catch (Exception e) {
