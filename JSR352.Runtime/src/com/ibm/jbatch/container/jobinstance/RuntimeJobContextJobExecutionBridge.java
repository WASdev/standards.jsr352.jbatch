...
public class RuntimeJobContextJobExecutionBridge {
	...
	public RuntimeJobContextJobExecutionBridge(JobInstance jobInstance, long executionId) {
		this.jobInstance = jobInstance;
		this.executionId = executionId;
		this.operatorJobExecution = 
				new JobOperatorJobExecutionImpl(executionId, jobInstance.getInstanceId());
	}
