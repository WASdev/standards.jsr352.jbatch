...
public class JobXMLLoaderServiceImpl implements IJobXMLLoaderService {
    ...
    protected static IJobXMLLoaderService preferredJobXmlLoader = (IJobXMLLoaderService) ServicesManager.getInstance().getService(ServiceType.JOBXML_LOADER_SERVICE);
