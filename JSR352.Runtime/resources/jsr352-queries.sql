...
-- job instance
SELECT id AS jobinstanceid FROM jbatch.jobinstancedata WHERE id = '56888'

-- job execs
SELECT id AS jobexecid FROM jbatch.executioninstancedata WHERE jobinstanceid = '56888'
-- returns 56889
...
DELETE FROM jbatch.jobinstancedata WHERE apptag = 'foo';
